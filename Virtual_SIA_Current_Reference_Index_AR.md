# Virtual-SIA Current Reference Index (Arabic)
...
- `prototype_v3b_curriculum`
  - file: `virtual_sia/eval/task_sets/prototype_v3b_curriculum.py`
  - runner: `virtual_sia/eval/runners/run_local_eval_v3b_curriculum.py`

## Diagnostic regime
- `prototype_v4_cases`
  - file: `virtual_sia/eval/task_sets/prototype_v4_cases.py`
  - runner: `virtual_sia/eval/runners/run_local_eval_v4.py`
...
## Core objects
- `virtual_sia/core/objects/task.py`
- `virtual_sia/core/objects/task_case.py`
- `virtual_sia/core/objects/blackboard.py`
- `virtual_sia/core/objects/memory.py`
- `virtual_sia/core/objects/concept.py`
- `virtual_sia/core/objects/contradiction.py`
- `virtual_sia/core/objects/anomaly.py`
- `virtual_sia/core/objects/theory.py`
- `virtual_sia/core/objects/decision.py`
- `virtual_sia/core/objects/ledger.py`

## Runtime modules
- `virtual_sia/runtime/task_ingress/service.py`
- `virtual_sia/runtime/task_ingress/normalize.py`
- `virtual_sia/runtime/blackboard_core/service.py`
- `virtual_sia/runtime/memory_os/store.py`
- `virtual_sia/runtime/memory_os/retriever.py`
- `virtual_sia/runtime/reasoning_runtime/service.py`
- `virtual_sia/runtime/verification_runtime/service.py`
- `virtual_sia/runtime/economy_control/router.py`
- `virtual_sia/runtime/economy_control/escalation.py`
- `virtual_sia/runtime/concept_engine/*`
- `virtual_sia/runtime/contradiction_runtime/service.py`
- `virtual_sia/runtime/anomaly_runtime/service.py`
- `virtual_sia/runtime/theory_runtime/*`
- `virtual_sia/runtime/pipeline/minimal_run.py`

## Evaluation modules
- `virtual_sia/eval/runners/*`
- `virtual_sia/eval/reports/*`
- `virtual_sia/eval/perturbations/taskcase_variants.py`
- `virtual_sia/eval/task_sets/*`
