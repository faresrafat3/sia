# Virtual-SIA Self-Benchmarking Implementation Memo
...
**المسار**: `virtual_sia/eval/benchmark_generator.py`
...
**المسار**: `virtual_sia/eval/reports/blind_spot_discovery.py`
...
**المسار**: `virtual_sia/eval/reports/diagnostic_value.py`
...
**المسار**: `virtual_sia/eval/runners/run_self_benchmark_cycle.py`
...
from virtual_sia.eval.task_sets.prototype_v6_cases import build_v6_cases
