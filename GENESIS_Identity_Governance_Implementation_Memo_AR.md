# Virtual-GENESIS: مذكرة تنفيذ حوكمة هوية الوكيل (H9)
...
**الملف**: `virtual_genesis/core/objects/identity.py`
...
**الملف**: `virtual_genesis/runtime/identity_runtime/drift_detector.py`
...
**الملف**: `virtual_genesis/runtime/identity_runtime/commitment_ledger.py`
...
**الملف**: `virtual_genesis/runtime/identity_runtime/governance.py`
...
**الملف**: `virtual_genesis/runtime/pipeline/minimal_run.py`
