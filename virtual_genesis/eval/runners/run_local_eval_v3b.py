...
from ..task_sets.prototype_v3b_cases import PROTOTYPE_V3B_CASES
...
def run_local_eval_v3b(output_path: str = "virtual_genesis/eval/results/prototype_v3b_summary.json") -> dict:
    classification_report = build_case_report(PROTOTYPE_V3B_CASES)
    results = compare_conditions(DEFAULT_CONDITIONS, PROTOTYPE_V3B_CASES, task_set_ref="prototype_v3b")
    summary = summarize_comparison(results)
    payload = {
        "task_count": len(PROTOTYPE_V3B_CASES),
