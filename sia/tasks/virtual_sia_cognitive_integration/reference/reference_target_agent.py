...
async def run_optimization_for_module(
    ...
    system_prompt = (
        ...
        "and structural optimization on the Virtual-SIA codebase. Specifically, you must optimize the "
...
async def main():
    parser = argparse.ArgumentParser(description="Virtual-SIA Cognitive Architecture Self-Evolution Agent")
