# Virtual-GENESIS - مذكرة دورة الاستفادة من النظريات
...
|-------|------------|---------------|
| `virtual_genesis/core/objects/theory.py` | Extension | 4 حقول جديدة في LocalTheoryObject |
| `virtual_genesis/runtime/theory_runtime/apply.py` | Addition | get_theory_prediction_for_task, update_theory_predictive_value, check_theory_explains_contradiction |
| `virtual_genesis/runtime/verification_runtime/service.py` | Addition | verify_output_theory_guided |
| `virtual_genesis/runtime/concept_engine/apply.py` | Addition | select_applicable_concepts_theory_guided |
| `virtual_genesis/runtime/economy_control/router.py` | Addition | choose_tier_theory_guided |
| `virtual_genesis/runtime/pipeline/minimal_run.py` | Integration | تكامل كل الدوال ضمن run_minimal_pipeline |
