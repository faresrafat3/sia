# Virtual-SIA Prototype Slice Plan (Arabic)

## 0) الغرض من هذه الوثيقة
هذه الوثيقة تجيب عن السؤال:

> ما هي **أصغر نسخة قابلة للبناء والاختبار** من Virtual-SIA بحيث تختبر الفرضيتين المركزيتين، دون أن نحاول بناء النظام الكامل دفعة واحدة؟
