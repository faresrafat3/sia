# Virtual-SIA Productive Forgetting Implementation Memo
...
**المكان**: `virtual_sia/runtime/memory_os/store.py` - دالة `apply_decay(decay_rate)`
...
**المكان**: `virtual_sia/runtime/memory_os/store.py`
...
**المسار**: `virtual_sia/runtime/memory_os/utility.py`
...
**المسار**: `virtual_sia/runtime/memory_os/forgetting_policy.py`
...
**المكان**: `virtual_sia/runtime/pipeline/minimal_run.py`
...
from virtual_sia.runtime.memory_os.utility import compute_memory_utility
