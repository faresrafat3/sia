...
def run_local_eval_v3b_curriculum(output_path: str = "virtual_sia/eval/results/prototype_v3b_curriculum_summary.json") -> dict:
    results = compare_conditions(DEFAULT_CONDITIONS, PROTOTYPE_V3B_CURRICULUM, task_set_ref="prototype_v3b_curriculum")
