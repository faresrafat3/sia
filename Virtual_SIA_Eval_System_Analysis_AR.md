# Virtual SIA - Evaluation System Analysis
# تحليل نظام التقييم
...
The evaluation system is located in `virtual_sia/eval/` and follows a layered pipeline architecture:
...
### 1.1 Task Sets (`virtual_sia/eval/task_sets/`)
...
### 1.2 Perturbations (`virtual_sia/eval/perturbations/`)
...
### 1.3 Runners (`virtual_sia/eval/runners/`)
...
### 1.4 Reports (`virtual_sia/eval/reports/`)
